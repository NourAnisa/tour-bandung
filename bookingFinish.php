...
?>
    ...
    <div class="container padding20 grid" style="background-color: #FFFFFF;">
		<legend>Ayo Jalan Kuy <i class="place-right"><small>Tanggal : <?php $tgl= date("d M Y"); echo $tgl;?></small></i></legend>
		<div class="row">
            <div class="span4">
				<p class="tertiary-text-secondary"><strong>Ayo Jalan Kuy </strong><br />
				Jalan Laksda Adisucipto 6.5 KM<br />
				Sleman, Yogyakarta</p>
				<p class="tertiary-text-secondary">ayojalankuy@gmail.com<br />
				08954352345</p>
				<p class="tertiary-text-secondary">BCA : 3120618040 a/n Muriasih<br />
				Mandiri : 1110005416478 a/n Nor Anisa</p>
            </div>
			<div class="span3">
			...
			<div class="span4 place-right">
				<p class="tertiary-text-secondary text-right">AyoJalanKuy-00<?php echo $isi_tbl['id_pesan'];?></p>
